...
const profile = {
    name: 'Dinesh RK',
    title: 'Junior Web Developer | Freelancer | Problem Solver',
    skills: [
        'React', 'NextJS', 'Redux', 'Express',
        'MySQL', 'Supabase', 'Laravel', 'AWS',
        'Figma', 'Git', 'Linux', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    ...
    <>
      <main className="text-white min-h-screen">
        ...
        >
          ...
          {/* Remove these background components */}
          {/* <GridBackground /> */}
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Full-stack explorer 🌐 | Bridging
