...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "c25c946f-53f5-481d-bf1d-28c01b5dcebc"); // Replace with Web3Forms access key
  ...
  return (
    <main className="pt-20 lg:pt-[0rem] text-white min-h-screen">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">drkrypt@outlook.com</p>
                  </div>
                </div>
